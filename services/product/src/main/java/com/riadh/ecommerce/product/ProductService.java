...
import com.riadh.ecommerce.exception.ProductPurchaseException;
...
public class ProductService {
    ...
    public List<ProductPurchaseResponse> purchaseProducts(List<ProductPurchaseRequest> request) {
        ...
        for(int i = 0; i < storedRequests.size(); i++) {
            ...
            // FIXED: Subtract requested quantity FROM available quantity
    ...
    public ProductResponse findById(Integer productId) {
        return repository.findById(productId)
                ...
                .orElseThrow(()->new EntityNotFoundException("Porduct not found with the Id::"+ productId));
    }
